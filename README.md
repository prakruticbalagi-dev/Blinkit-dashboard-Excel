...
•	To analyze total sales and average sales across outlets
...
1.	Data Collection – Imported raw dataset into Excel

2.	Data Cleaning – Removed duplicates, handled missing values

3.	Data Transformation – Categorized data (fat content, outlet size, etc.)

4.	Data Modeling – Created Pivot Tables for analysis

5.	Visualization – Designed charts and KPIs

6.	Dashboard Creation – Combined all visuals into one interactive sheet
________________________________________
Dashboard Features
...
o	Donut Charts: Fat Content, Outlet Size

o	Bar Charts: Item Type, Outlet Type

o	Trend Analysis: Outlet Establishment over years

o	Location Analysis: Tier-wise sales distribution

•	Filters (Slicers):

o	Outlet Size (High, Medium, Small)
________________________________________
Key Insights
...
4.	Interact with charts for insights
